...
Copies of these notebooks are available on your SANE environment (`S:/Scripts/llm_notebooks/`) for easy access.
...
- *Recommended setup*: Run these notebooks inside SANE with sensitive data like FIRMBACKBONE to get a feeling of how to use LLMs for secure data collection/annotation without relying on cloud services. This is especially useful for when you develop your own projects later. 
